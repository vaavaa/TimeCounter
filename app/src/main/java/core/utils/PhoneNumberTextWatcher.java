...
public class PhoneNumberTextWatcher implements TextWatcher {
     ...
     */
    public PhoneNumberTextWatcher(OnPhoneChangedListener listener, Context mContext) {
        this(Locale.getDefault().getCountry(), mContext);
     ...
     * @hide
     */
    public PhoneNumberTextWatcher(String countryCode, Context context) {
        if (countryCode == null) throw new IllegalArgumentException();
        mFormatter = PhoneNumberUtil.createInstance(context).getAsYouTypeFormatter(countryCode);
    }
